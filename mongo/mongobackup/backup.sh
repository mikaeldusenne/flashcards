...
mongodump --host="mikarezoo-flashcards_mongo_docker" --archive="$FILE" --gzip --username $MONGO_INITDB_ROOT_USERNAME --password $MONGO_INITDB_ROOT_PASSWORD --db $MONGO_INITDB_DATABASE
# RESTORE OPERATION:
